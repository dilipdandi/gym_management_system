...
if(isset($_POST["btn"]))
{
  ...
  $query="UPDATE `user` set `name`='$name',`email`='$email',`gender`='$gender',`weight`='$weight',`batch`='$batch',`mobile`='$contact',
          `password`='$pass',`addr`='$addr' where `id`='$u'";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <a class="navbar-brand " href="uhome.php" style="color:#0ef;"> <span class="glyphicon glyphicon-home"> </span> Fitness World<i class='fas fa-heartbeat' style="color:#0ef;"></i></a>
    </div>
...
<br>
<h1 class="font-weight-bold text-center">Hi <?php echo $n; ?>!</h1>
<br>
...
<?php
  ...
  <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputEmail4" name="Fname" required value="<?php echo $row['name'];?>">
    </div>

    <div class="form-group col-md-6">
      <label for="inputEmail4" class="font-weight-bold h5" style="font-size:20px;">Email</label>
      <input type="email" class="form-control" id="inputEmail4" name="Email" required value="<?php echo $row['email'];?>">
    </div>
  ...
  <label class="form-check-label font-weight-bold h5 form-row mt-4" for="Gender" style="font-size:20px;">Gender :</label>
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputCity" name="Weight" required value="<?php echo $row['weight'];?>">

    </div>
    <div class="form-group col-md-6">
      <label for="inputName4" class="font-weight-bold h5" style="font-size:20px;">Address</label>
      <input type="text" class="form-control" id="inputEmail4" name="addr"required value="<?php echo $row['addr'];?>">
    </div>  
